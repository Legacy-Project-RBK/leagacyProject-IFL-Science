        ...
        return (
            <div>
                ...
                <div>
                    ...
                    return <div className="comment-body" key={comment._id}>
                                ...
                                <div className="comment-content">
                                    ...
                                    <div className="comment-actions">
                                        ...
                                        <span><button>({this.state.likes}) Likes</button></span>
                                        <span><button onClick={this.increase.bind(this)}>Like</button></span>
                                        <span><button onClick={this.decrease.bind(this)}>Unlike</button></span>
                                    </div>
                                    <hr/>
