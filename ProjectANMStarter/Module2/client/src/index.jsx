  ...
  render() {
    return (
      <div className="widgetContainerBox">
        ...
        <h1 className="WidgeTitleBox"> POPULAR STORIES</h1>{" "}
        {/*box 2 contains title*/}
        <div className="WidgetContentBox">
          {" "}
          {/*box 3 contains pics and titles of the articles*/}
